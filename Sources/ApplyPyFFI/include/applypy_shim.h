#ifndef APPLYPY_SHIM_H
#define APPLYPY_SHIM_H
...
static inline PyObject* ApplyPy_ModuleCreate(PyModuleDef *def) {
...
static inline int ApplyPy_ListCheck(PyObject *o) {
    return PyList_Check(o);
}

/// Check if a PyObject is a dict (or dict subclass).
static inline int ApplyPy_DictCheck(PyObject *o) {
    return PyDict_Check(o);
}

/// Check if a PyObject is a tuple (or tuple subclass).
static inline int ApplyPy_TupleCheck(PyObject *o) {
    return PyTuple_Check(o);
}

/// Check if a PyObject is a set.
static inline int ApplyPy_SetCheck(PyObject *o) {
    return PyAnySet_Check(o);
}

/// Check if a PyObject is bytes.
static inline int ApplyPy_BytesCheck(PyObject *o) {
    return PyBytes_Check(o);
}

/// Check if a PyObject is a Unicode string.
static inline int ApplyPy_UnicodeCheck(PyObject *o) {
    return PyUnicode_Check(o);
}

/// Check if a PyObject is a long/int.
static inline int ApplyPy_LongCheck(PyObject *o) {
    return PyLong_Check(o);
}

/// Check if a PyObject is a float.
static inline int ApplyPy_FloatCheck(PyObject *o) {
    return PyFloat_Check(o);
}

#endif // APPLYPY_SHIM_H
